...
from src.database import get_db_cursor, get_db_connection, cache_response
...
def give_resource(giver_id, taker_id, resource, amount):
    ...
    with get_db_connection() as conn:
        ...
        if resource in ["gold", "money"]:
            ...
            from src.helpers import validate_resource_column, apply_resource_delta
...
def register_market_routes(app_instance):
    ...
    from src.database import cache_response
