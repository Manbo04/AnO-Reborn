...
from src.attack_scripts.Nations import (
    Economy as AttackEconomy,
    Economy,
    Nation as AttackNation,
    Military,
)
from src.attack_scripts import Nation
import time
        ...
        with get_db_connection() as connection:
            ...
            if decision == "1":
                ...
                for idx, res in enumerate(resources):
                    ...
                    from src.market import give_resource
...
def warResult():
    ...
    with get_db_cursor() as db:
        ...
        if result is None:
            ...
            from src.units import Units as UnitsClass
