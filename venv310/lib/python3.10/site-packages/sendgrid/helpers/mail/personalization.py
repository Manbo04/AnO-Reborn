    ...
    def _get_unique_recipients(self, recipients):
        ...
        for recipient in recipients:
            recipient_email = (
                ...
                else recipient.email.lower()
            )
            if all(
                unique_recipient["email"].lower() != recipient_email
                for unique_recipient in unique_recipients
            ):
                new_unique_recipient = (
                    recipient if isinstance(recipient, dict) else recipient.get()
                )
