...
if IS_TYPE_CHECKING:
    from typing import IO, Dict, Iterator, Match, Optional, Pattern, Text, Tuple, Union
...
def resolve_nested_variables(values):
    ...
    for k, v in values.items():
        new_values[k] = (
            __posix_variable.sub(_re_sub_callback, v) if v is not None else None
        )
...
def dotenv_values(
    dotenv_path=None, stream=None, verbose=False, interpolate=True, **kwargs
):
