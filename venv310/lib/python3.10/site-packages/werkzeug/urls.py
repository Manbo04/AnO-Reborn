...
from ._compat import (PY2, fix_tuple_repr, implements_to_string,
                      make_literal_wrapper, normalize_string_tuple, text_type,
                      to_native, to_unicode, try_coerce_native)
from ._internal import _decode_idna, _encode_idna
