...
from ._compat import (PY2, integer_types, iteritems, string_types, text_type,
                      to_bytes, to_unicode, try_coerce_native)
from ._internal import _cookie_parse_impl, _cookie_quote, _make_cookie_domain
...
from .datastructures import (Accept, Authorization, ContentRange, ETags,
                             HeaderSet, IfRange, Range, RequestCacheControl,
                             TypeConversionDict, WWWAuthenticate)
