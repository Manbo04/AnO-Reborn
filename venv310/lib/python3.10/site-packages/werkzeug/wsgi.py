...
from ._compat import (BytesIO, implements_iterator, make_literal_wrapper,
                      string_types, text_type, to_bytes, to_unicode,
                      try_coerce_native, wsgi_get_bytes)
from ._internal import _encode_idna
from .urls import uri_to_iri, url_join, url_parse, url_quote
