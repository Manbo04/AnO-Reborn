...
from ._compat import (PY2, BytesIO, collections_abc, integer_types, iteritems,
                      iterkeys, iterlists, itervalues, make_literal_wrapper,
                      string_types, text_type, to_native)
...
from .http import (dump_header, dump_options_header, generate_etag, http_date,
                   is_byte_range_valid, parse_options_header, parse_set_header,
                   quote_etag, quote_header_value, unquote_etag)
