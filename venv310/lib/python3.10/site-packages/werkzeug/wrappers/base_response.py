...
from .._compat import integer_types, string_types, text_type, to_bytes, to_native
from ..datastructures import Headers
from ..http import HTTP_STATUS_CODES, dump_cookie, remove_entity_headers
from ..urls import iri_to_uri, url_join
