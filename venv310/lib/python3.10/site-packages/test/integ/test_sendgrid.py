...
class UnitTests(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.path = "{}{}".format(os.path.abspath(os.path.dirname(__file__)), "/..")
    ...
    def test_impersonate_subuser_init(self):
        ...
        sg_impersonate = sendgrid.SendGridAPIClient(impersonate_subuser=temp_subuser)
    ...
    def test_asm_groups__group_id__suppressions_search_post(self):
        ...
        group_id = "test_url_param"
        headers = {"X-Mock": 200}
        response = self.sg.client.asm.groups._(group_id).suppressions.search.post(
            request_body=data, request_headers=headers
        )
        self.assertEqual(response.status_code, 200)
    ...
    def test_asm_groups__group_id__suppressions__email__delete(self):
        ...
        headers = {"X-Mock": 204}
        response = (
            self.sg.client.asm.groups._(group_id)
            .suppressions._(email)
            .delete(request_headers=headers)
        )
        self.assertEqual(response.status_code, 204)
    ...
    def test_asm_suppressions_global__email__get(self):
        ...
        headers = {"X-Mock": 200}
        response = (
            self.sg.client.asm.suppressions._("global")
            ._(email)
            .get(request_headers=headers)
        )
        self.assertEqual(response.status_code, 200)
    ...
    def test_contactdb_lists__list_id__recipients__recipient_id__post(self):
        ...
        headers = {"X-Mock": 201}
        response = (
            self.sg.client.contactdb.lists._(list_id)
            .recipients._(recipient_id)
            .post(request_headers=headers)
        )
        self.assertEqual(response.status_code, 201)
    ...
    def test_contactdb_lists__list_id__recipients__recipient_id__delete(self):
        ...
        response = (
            self.sg.client.contactdb.lists._(list_id)
            .recipients._(recipient_id)
            .delete(query_params=params, request_headers=headers)
        )
        self.assertEqual(response.status_code, 204)

    def test_contactdb_recipients_patch(self):
        data = [
            {"email": "jones@example.com", "first_name": "Guy", "last_name": "Jones"}
        ]
        headers = {"X-Mock": 201}
    ...
    def test_contactdb_segments__segment_id__recipients_get(self):
        ...
        segment_id = "test_url_param"
        headers = {"X-Mock": 200}
        response = self.sg.client.contactdb.segments._(segment_id).recipients.get(
            query_params=params, request_headers=headers
        )
        self.assertEqual(response.status_code, 200)
    ...
    def test_ips_pools__pool_name__ips__ip__delete(self):
        ...
        headers = {"X-Mock": 204}
        response = (
            self.sg.client.ips.pools._(pool_name)
            .ips._(ip)
            .delete(request_headers=headers)
        )
        self.assertEqual(response.status_code, 204)
    ...
    def test_mail_send_post(self):
        data = {
            ...
            "mail_settings": {
                "bcc": {"email": "ben.doe@example.com", "enable": True},
            ...
            "personalizations": [
                {
                    ...
                    "send_at": 1409348513,
                    "subject": "Hello, World!",
                    "substitutions": {"id": "substitutions", "type": "object"},
    ...
    def test_senders__sender_id__resend_verification_post(self):
        sender_id = "test_url_param"
        headers = {"X-Mock": 204}
        response = self.sg.client.senders._(sender_id).resend_verification.post(
            request_headers=headers
        )
        self.assertEqual(response.status_code, 204)
    ...
    def test_suppression_spam_report__email__get(self):
        email = "test_url_param"
        headers = {"X-Mock": 200}
        response = self.sg.client.suppression.spam_reports._(email).get(
            request_headers=headers
        )
        self.assertEqual(response.status_code, 200)
    ...
    def test_suppression_spam_report__email__delete(self):
        email = "test_url_param"
        headers = {"X-Mock": 204}
        response = self.sg.client.suppression.spam_reports._(email).delete(
            request_headers=headers
        )
        self.assertEqual(response.status_code, 204)
    ...
    def test_templates__template_id__versions__version_id__patch(self):
        ...
        headers = {"X-Mock": 200}
        response = (
            self.sg.client.templates._(template_id)
            .versions._(version_id)
            .patch(request_body=data, request_headers=headers)
        )
        self.assertEqual(response.status_code, 200)
    ...
    def test_templates__template_id__versions__version_id__activate_post(self):
        ...
        response = (
            self.sg.client.templates._(template_id)
            .versions._(version_id)
            .activate.post(request_headers=headers)
        )
        self.assertEqual(response.status_code, 200)
    ...
    def test_user_webhooks_parse_settings__hostname__patch(self):
        ...
        headers = {"X-Mock": 200}
        response = self.sg.client.user.webhooks.parse.settings._(hostname).patch(
            request_body=data, request_headers=headers
        )
        self.assertEqual(response.status_code, 200)
    ...
    def test_whitelabel_domains__id__ips_post(self):
        ...
        id_ = "test_url_param"
        headers = {"X-Mock": 200}
        response = self.sg.client.whitelabel.domains._(id_).ips.post(
            request_body=data, request_headers=headers
        )
        self.assertEqual(response.status_code, 200)
    ...
    def test_whitelabel_domains__id__ips__ip__delete(self):
        ...
        headers = {"X-Mock": 200}
        response = (
            self.sg.client.whitelabel.domains._(id_)
            .ips._(ip)
            .delete(request_headers=headers)
        )
        self.assertEqual(response.status_code, 200)
    ...
    def test_whitelabel_domains__id__validate_post(self):
        id_ = "test_url_param"
        headers = {"X-Mock": 200}
        response = self.sg.client.whitelabel.domains._(id_).validate.post(
            request_headers=headers
        )
        self.assertEqual(response.status_code, 200)
    ...
    def test_whitelabel_ips__id__get(self):
        id_ = "test_url_param"
        headers = {"X-Mock": 200}
        response = self.sg.client.whitelabel.ips._(id_).get(request_headers=headers)
        self.assertEqual(response.status_code, 200)

    def test_whitelabel_ips__id__delete(self):
        id_ = "test_url_param"
        headers = {"X-Mock": 204}
        response = self.sg.client.whitelabel.ips._(id_).delete(request_headers=headers)
        self.assertEqual(response.status_code, 204)

    def test_whitelabel_ips__id__validate_post(self):
        id_ = "test_url_param"
        headers = {"X-Mock": 200}
        response = self.sg.client.whitelabel.ips._(id_).validate.post(
            request_headers=headers
        )
        self.assertEqual(response.status_code, 200)
    ...
    def test_whitelabel_links__id__get(self):
        id_ = "test_url_param"
        headers = {"X-Mock": 200}
        response = self.sg.client.whitelabel.links._(id_).get(request_headers=headers)
        self.assertEqual(response.status_code, 200)

    def test_whitelabel_links__id__delete(self):
        id_ = "test_url_param"
        headers = {"X-Mock": 204}
        response = self.sg.client.whitelabel.links._(id_).delete(
            request_headers=headers
        )
        self.assertEqual(response.status_code, 204)
    ...
    def test_whitelabel_links__id__validate_post(self):
        id_ = "test_url_param"
        headers = {"X-Mock": 200}
        response = self.sg.client.whitelabel.links._(id_).validate.post(
            request_headers=headers
        )
        self.assertEqual(response.status_code, 200)
