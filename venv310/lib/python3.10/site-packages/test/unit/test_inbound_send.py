...
class UnitTests(unittest.TestCase):
    def setUp(self):
        ...
        self.open_mock = mock.patch(
            "sendgrid.helpers.inbound.send.open", mock.mock_open(), create=True
        )
    ...
    def test_main_call(self):
        ...
        with mock.patch(
            ...
            return_value=argparse.Namespace(host=fake_url, data="test_file.txt"),
        ):
            send.main()
            send.Client.assert_called_once_with(
                host=fake_url,
