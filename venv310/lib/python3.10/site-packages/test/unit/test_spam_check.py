...
class UnitTests(unittest.TestCase):
    def test_spam_all_values(self):
        expected = {
            "enable": True,
            "threshold": 5,
            "post_to_url": "https://www.test.com",
        }
        spam_check = SpamCheck(
            enable=True, threshold=5, post_to_url="https://www.test.com"
        )
    ...
    def test_has_values_but_not_enabled(self):
        ...
        spam_check = SpamCheck(
            enable=False, threshold=1, post_to_url="https://www.test.com"
        )
        self.assertEqual(spam_check.get(), expected)
    ...
    def test_spam_change_properties(self):
        ...
        expected = {
            "enable": False,
            "threshold": 10,
            "post_to_url": "https://www.testing.com",
        }
        spam_check = SpamCheck(
            enable=True, threshold=5, post_to_url="https://www.test.com"
        )
