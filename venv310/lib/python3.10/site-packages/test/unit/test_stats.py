...
class UnitTests(unittest.TestCase):
    def test_basicStats(self):
        ...
        self.assertEqual(
            json.dumps(global_stats.get(), sort_keys=True),
    ...
    def test_Stats(self):
        ...
        self.assertEqual(
            json.dumps(all_stats.get(), sort_keys=True),
    ...
    def test_categoryStats(self):
        category_stats = CategoryStats(
            start_date="12-09-2017", categories=["foo", "bar"]
        )
        ...
        self.assertEqual(
            json.dumps(category_stats.get(), sort_keys=True),
    ...
    def test_subuserStats(self):
        ...
        self.assertEqual(
            json.dumps(subuser_stats.get(), sort_keys=True),
            '{"aggregated_by": "day", "end_date": "12-10-2017", '
            '"limit": 100, "offset": 2, "sort_by_direction": "asc", '
            '"sort_by_metric": "clicks", "start_date": "12-09-2017", '
