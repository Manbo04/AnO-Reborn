...
def ground_attack(nat1_name, nat2_name, nat1_soldiers, nat2_soldiers):
    ...
    for roll in range(0, 3):
        ...
        print(
            f"This is random output of soldiers going to war for Nat1: {nat1_roll} out of {Nat1} soldiers.."
        )
        print(
            f"This is random output of soldiers going to war for Nat2: {nat2_roll} out of {Nat2} soldiers.."
        )
        ...
        if nat1_roll > nat2_roll:
            ...
            print(
                f"This is the is Nation 1's casualties from the battle: {twelve_percent_loss}"
            )
        else:
            nat2_roll_wins += 1
            # subtract difference from the nations maximum if they rolled lower
            ...
            print(
                f"This is the is Nation 2's casualties from the battle: {twelve_percent_loss}"
            )
