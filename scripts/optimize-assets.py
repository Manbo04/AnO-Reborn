...
def minify_js(js_content):
    ...
    js_content = re.sub(r'(if|else|for|while|function|return|var|let|const)([({])', r'\1 \2', js_content)
...
def optimize_css_files():
    ...
    for css_file in css_files:
        ...
        print(f"  Original: {original_size}B → Minified: {minified_size}B (saved {reduction:.1f}%)")
